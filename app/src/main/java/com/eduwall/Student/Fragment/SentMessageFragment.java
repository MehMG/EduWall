 ...
 */
public class SentMessageFragment extends BaseFragment {
    ...
    public SentMessageFragment(ArrayList<InboxMessege> sentArrayList, String sender) {
        this.inboxArrayList = sentArrayList;
        this.type = sender;
    }
